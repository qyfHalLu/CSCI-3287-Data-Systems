...
/*DROP DATABASE HW_4_SQL_sales_dw;*/


DROP DATABASE IF EXISTS HW_4_SQL_sales_dw;
CREATE DATABASE HW_4_SQL_sales_dw;
...
DELETE FROM HW_4_SQL_sales_dw.dim_date
WHERE DateKey NOT IN 
	(SELECT DISTINCT SalesDatekey
	FROM HW_4_SQL_sales_dw.Fact_ProductSales 
	)
;
